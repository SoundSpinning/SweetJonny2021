            ...
            for (const tab of dataTabs) {
                ...
                for (const track of dataTracks) {
                  ...
                  <span class="d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-secondary btn-info mb-1 px-2" data-bs-toggle="modal" data-bs-target="#modal-T${track.trackId}" data-bs-whatever="Lyrics" data-bs-dismiss="modal" aria-hidden="true"><i class="bi bi-journal-richtext"></i>
                    </button>
                    </span>
                  </span>
